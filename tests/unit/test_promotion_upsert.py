...
class FakeSession:
    """Small deterministic session double for the service-level idempotency test."""
...
def _item():
    return ExtractedPromotionItem(
        ...
        end_date="2026-09-30",
        retailer="Indomaret",
        evidence_quote="Roma Kelapa 300g Rp7.000 diskon 30%",
        confidence=0.95,
    )
...
def test_upsert_is_idempotent_for_same_document_and_promotion():
    ...
    first_promotion, first_observation, first_created = upsert_promotion_observation(
        ...
        extracted_json={"product_name": "Roma Kelapa 300g"},
    ...
    second_promotion, second_observation, second_created = upsert_promotion_observation(
        ...
        item=_item(),
        raw_text="Roma Kelapa 300g Rp7.000 diskon 30%",
        extracted_json={"product_name": "Roma Kelapa 300g", "revision": 2},
        observed_at=observed_at,
        source_url="https://example.test/promo",
        extraction_metadata=second_metadata,
    )
