...
class PromotionObservation(Base):
    ...
    promotion_id: Mapped[Optional[uuid.UUID]] = mapped_column(UUID(as_uuid=True), ForeignKey("competitor_intel.promotions.id", ondelete="SET NULL"), nullable=True, index=True)
...
class Promotion(Base):
    ...
    supersedes_promotion_id: Mapped[Optional[uuid.UUID]] = mapped_column(UUID(as_uuid=True), ForeignKey("competitor_intel.promotions.id", ondelete="SET NULL"), nullable=True, index=True)
    ...
    superseded_promotion: Mapped[Optional["Promotion"]] = relationship("Promotion", remote_side=[id], foreign_keys=[supersedes_promotion_id])
